...
_QUALIFICATION_SYSTEM = (
    ...
    "Do NOT confuse scope with seniority: a Senior/Sr. individual-contributor title (e.g. Senior "
    "Technical Program Manager, Senior Product Manager) and cross-team program coordination — "
    "driving a program across several engineering teams without managing them, as TPMs do, "
    "including at big tech — are NOT above scope on those grounds alone. "
